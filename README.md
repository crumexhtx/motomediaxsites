...
- Exterior dimensions from NHTSA Canadian Vehicle Specs: `pnpm enrich:nhtsa-dims` (fills missing L/W/H/wheelbase/curb weight without a full catalog rebuild; `--force` overwrites)
